...
class AppRouter {
  ...
  static List<GoRoute> _routes() => [
    GoRoute(path: AppRoutes.splash,name: 'splash', builder: (_, _) => const SplashPage()),

    GoRoute(path: AppRoutes.home,name: 'home', builder: (_, _) => const HomePage()),

    GoRoute(path: AppRoutes.detail,name: 'detail',
    ...
    GoRoute(
      path: AppRoutes.favorites,name: 'favorites',
      builder: (_, _) => const FavoritesPage(),
    ),
    GoRoute(
      path: AppRoutes.settings,name: 'settings',
      builder: (_, _) => const SettingPage(),
    ),
    GoRoute(
      path: AppRoutes.bottomNavBar,name: 'bottomNavBar',
